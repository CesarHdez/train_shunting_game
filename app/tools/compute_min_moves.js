...
// Uso: node tools/compute_min_moves.js
// Escribe el campo "minMoves" en cada assets/levels/shunting/level_NN.json
//
// Ported unmodified from ref/compute_min_moves.js (game-logic solver).
// Only the LEVELS_DIR path was adjusted to point at this app's bundled
// level JSONs (app/assets/levels/shunting) instead of the reference web
// app's levels/shunting directory. Do NOT change level content — this
// tool only recomputes/verifies the minMoves field, and re-running it on
// unmodified level content must reproduce the same values that are
// already checked in.
...
const LEVELS_DIR  = path.join(__dirname, '..', 'assets', 'levels', 'shunting');
